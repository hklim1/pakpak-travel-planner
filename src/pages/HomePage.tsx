        ...
        <div className="second-container">
          ...
          <div className="image-holder">
            <div className="info-card">
              ...
              <h5>Cool Tables</h5>
              <p>Table layouts ensure that you never forget a detail for any part of your trip</p>
            </div>
            <div className="info-card">
              ...
              <p>I'm dumb and hard coded this whole thing in Vanilla CSS so it deserves to be used</p>
            </div>
            <div className="info-card">
              <div className="info-card-icon-r">
                < BookHeart size={55} />
              ...
              <h5>Drag and Drop</h5>
              <p>Drag and Drop feature enables seamless organization of activities for every day of your trip</p>
            </div>
            <div className="info-card">
              <div className="info-card-icon-g">
                < Map size={55} />
              ...
              <h5>Google Maps</h5>
              <p>GoogleMaps API allows you to find interesting restaurants, attractions, and landmarks nearby</p>
            </div>
          </div>
        </div>
      </div>
